...
export default function ChannelError({
  ...
  useEffect(() => {
    console.error("SphinxTV channel load error:", error);
  }, [error]);
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-xl flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-xs text-zinc-400 mb-6">
        We were unable to establish a secure connection with this broadcast feed at this time.
      </p>
      <div className="flex items-center gap-4">
        ...
        <Link
          href="/live"
          className="flex items-center gap-2 rounded-2xl border border-surface-border bg-surface px-5 py-2.5 text-xs font-bold text-zinc-300 transition-colors hover:border-gold hover:text-white"
        >
